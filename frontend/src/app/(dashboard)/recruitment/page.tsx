  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1600px] mx-auto pb-12">
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col min-h-[600px]">
        <div className="px-8 border-b border-slate-100 flex items-center gap-8 bg-slate-50/40">
          {([
            ...
            <button key={tab.key} onClick={() => setActiveTab(tab.key)}
              className={`py-5 text-[10px] font-black uppercase tracking-[0.18em] border-b-2 transition-all flex items-center gap-2 ${activeTab === tab.key ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-400 hover:text-slate-600'}`}>
              {tab.label}
