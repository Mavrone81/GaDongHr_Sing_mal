            ...
            <div className="flex flex-col gap-5 p-8">
              ...
              {templateEmpId && !templatePreview && (
                <div className="flex items-center gap-2 px-4 py-2 text-[10px] font-bold text-muted">
                  <span className="w-3 h-3 border-2 border-rule border-rule animate-spin" />
              ...
              <div className="flex gap-3 pt-1">
                ...
                {!provisionResult?.ok && (
                  ...
                  >
                    {provisioning && <span className="w-3 h-3 border-2 border-white/40 border-t-white animate-spin" />}
            ...
            <div className="px-8 py-5 border-t border-rule flex items-center justify-between flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  {approvingId === reviewingApp.id && <span className="w-3.5 h-3.5 border-2 border-white/30 border-t-white animate-spin" />}
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-shadow backdrop-">
          <div className="w-full max-w-2xl bg-paper flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <div className="px-8 py-5 border-t border-rule flex items-center justify-between flex-shrink-0">
              ...
              >
                {hrFillSubmitting && <span className="w-3.5 h-3.5 border-2 border-white/30 border-t-white animate-spin" />}
