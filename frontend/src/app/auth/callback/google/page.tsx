...
export default function GoogleCallbackPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-2xl p-10 w-full max-w-sm text-center flex flex-col items-center gap-5">
        <div className="w-14 h-14 bg-indigo-50 border-2 border-indigo-200 rounded-2xl flex items-center justify-center">
        ...
        <div>
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Verifying your Google account…</p>
        </div>
      </div>
    </div>
  );
